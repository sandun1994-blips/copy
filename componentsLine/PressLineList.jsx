...
const [refresh, setRefresh] = useState(false)
  ...
  const fetchData = async () => {
    try {
      const response = await RestaurantFinder.get("/pressotherdata/pressline");
  ...
  const handleDelete = async (e, id) => {
    ...
    try {
      const response = await RestaurantFinder.delete(`/pressotherdata/pressline/delete/${id}`);
      if(response){
        
        const responseTwo = await RestaurantFinder.get("/pressotherdata/pressline/");
          setRefresh(true)
