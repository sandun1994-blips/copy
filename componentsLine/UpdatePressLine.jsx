...
const UpdatePressLine = (props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await RestaurantFinder.get(`/pressotherdata/pressline/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    //   rating,
    // });
    const update = await RestaurantFinder.post(`/pressotherdata/pressline/update/${id}`, { date, shift,mp,dot,head_count,ai,ani,line_no,id
     ,
    });
   console.log(update);
